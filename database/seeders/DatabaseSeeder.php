...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedProducts(): int
    {
        $products = [
            ...
            // NOTICE OF ARRIVAL: SPECTRUM DIAGNOSTIC INDUSTRIES — CHEMISTRY & REAGENT KITS (44)
            ['SPC-001', 'Albumin 4x100ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Albumin 4x100ml'],
            ['SPC-002', 'Bilirubin Total/Direct 2x55ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Bilirubin Total/Direct'],
            ['SPC-003', 'Cholesterol 4x25ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Cholesterol 4x25ml'],
            ['SPC-004', 'Cholesterol 4x50ml', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Cholesterol 4x50ml'],
            ['SPC-005', 'Triglycerides 4x25ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Triglycerides 4x25ml'],
            ['SPC-006', 'Triglycerides 4x50ml', 'Laboratory', 35300, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Triglycerides 4x50ml'],
            ['SPC-007', 'Urea Colorimetric 2x100ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Urea Colorimetric'],
            ['SPC-008', 'Uric Acid 4x50ml', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Uric Acid 4x50ml'],
            ['SPC-009', 'Creatinine Jaffe 2x100ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Creatinine Jaffe 2x100ml'],
            ['SPC-010', 'Creatinine Jaffe 4x100ml', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Creatinine Jaffe 4x100ml'],
            ['SPC-011', 'Alkaline Phosphatase (1+1) Kinetic 4x25ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Alkaline Phosphatase Kinetic'],
            ['SPC-012', 'Alkaline Phosphatase Colorimetric 166ml', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Alkaline Phosphatase Colorimetric'],
            ['SPC-013', 'GOT/AST (1+1) Kinetic 4x25ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — GOT/AST Kinetic'],
            ['SPC-014', 'GPT/ALT (1+1) Kinetic 4x25ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — GPT/ALT Kinetic'],
            ['SPC-015', 'HDL-Cholesterol Precipitation 1x50ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — HDL-Cholesterol Precipitation'],
            ['SPC-016', 'GOT/AST Colorimetric 2x100ml', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — GOT/AST Colorimetric'],
            ['SPC-017', 'GPT/ALT Colorimetric 2x100ml', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — GPT/ALT Colorimetric'],
            ['SPC-018', 'Chloride 4x50ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Chloride 4x50ml'],
            ['SPC-019', 'Magnesium 4x25ml', 'Laboratory', 31225, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Magnesium 4x25ml'],
            ['SPC-020', 'CO2 (Single Reagent) 2x25ml', 'Laboratory', 48100, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — CO2 Single Reagent'],
            ['SPC-021', 'Uniceline PTT Reagent 5x3ml', 'Laboratory', 41950, 20, 'Spectrum Diagnostic Industries coagulation reagent kit — Uniceline PTT'],
            ['SPC-022', 'Recoplastin PT Reagent ISI 1.0 6x5ml', 'Laboratory', 38500, 20, 'Spectrum Diagnostic Industries coagulation reagent kit — Recoplastin PT ISI 1.0'],
            ['SPC-023', 'Total Protein 4x100ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Total Protein 4x100ml'],
            ['SPC-024', 'Potassium 4x25ml', 'Laboratory', 31700, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Potassium 4x25ml'],
            ['SPC-025', 'Sodium (Single Reagent) 4x25ml', 'Laboratory', 31700, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Sodium Single Reagent'],
            ['SPC-026', 'CRP (Complete Kit) 100 Test', 'Laboratory', 28700, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — CRP Complete Kit'],
            ['SPC-027', 'Calcium OCPC 2x100ml', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Calcium OCPC 2x100ml'],
            ['SPC-028', 'Glucose GOD-PAP (Two Reagents) 3x100ml', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Glucose GOD-PAP'],
            ['SPC-029', 'g-GT (1+1) Kinetic 4x25ml', 'Laboratory', 31225, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — g-GT Kinetic 4x25ml'],
            ['SPC-030', 'Anti-Human Globulin 10x10ml (box of 10 bottles)', 'Laboratory', 84500, 10, 'Spectrum Diagnostic Industries blood grouping reagent — Anti-Human Globulin, box of 10 bottles'],
            ['SPC-031', 'BSA 22% 10x10ml (box of 10 bottles)', 'Laboratory', 55500, 10, 'Spectrum Diagnostic Industries blood grouping reagent — BSA 22%, box of 10 bottles'],
            ['SPC-032', 'Phosphorus UV (Single Reagent) 2x100ml', 'Laboratory', 26100, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Phosphorus UV Single Reagent'],
            ['SPC-033', 'HDL-Direct/W. Calibrator R1 30ml/R2 10ml', 'Laboratory', 48600, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — HDL-Direct with Calibrator'],
            ['SPC-034', 'LDL-Direct/W. Calibrator R1 30ml/R2 10ml', 'Laboratory', 51100, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — LDL-Direct with Calibrator'],
            ['SPC-035', 'Anti-A (IgM) 10x10ml (box of 10 bottles)', 'Laboratory', 33800, 10, 'Spectrum Diagnostic Industries blood grouping reagent — Anti-A IgM, box of 10 bottles'],
            ['SPC-036', 'Anti-B (IgM) 10x10ml (box of 10 bottles)', 'Laboratory', 33800, 10, 'Spectrum Diagnostic Industries blood grouping reagent — Anti-B IgM, box of 10 bottles'],
            ['SPC-037', 'Anti-AB (IgM) 10x10ml (box of 10 bottles)', 'Laboratory', 46500, 10, 'Spectrum Diagnostic Industries blood grouping reagent — Anti-AB IgM, box of 10 bottles'],
            ['SPC-038', 'Anti-D (IgG+IgM) 10x10ml (box of 10 bottles)', 'Laboratory', 53500, 10, 'Spectrum Diagnostic Industries blood grouping reagent — Anti-D IgG+IgM, box of 10 bottles'],
            ['SPC-039', 'Amylase (4+1) 2x25ml', 'Laboratory', 32100, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Amylase 2x25ml'],
            ['SPC-040', 'G-6PDH 100 Test', 'Laboratory', 29000, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — G-6PDH 100 Test'],
            ['SPC-041', 'LDH (1+1) 4x25ml', 'Laboratory', 29600, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — LDH 4x25ml'],
            ['SPC-042', 'ASOT (Complete Kit) 100 Test', 'Laboratory', 26900, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — ASOT Complete Kit'],
            ['SPC-043', 'RF (Complete Kit) 100 Test', 'Laboratory', 26500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — RF Complete Kit'],
            ['SPC-044', 'Total Chromazurol B Single Reagent', 'Laboratory', 31500, 20, 'Spectrum Diagnostic Industries chemistry reagent kit — Total Chromazurol B Single Reagent'],
            // NOTICE OF ARRIVAL: CTK BIOTECH INC, USA — ONSITE RAPID TEST CASSETTE & ELISA KITS (10)
            ['CTK-001', 'R0024C / OnSite HCV Ab Plus Combo Rapid Test Cassette, 30 Test/kit', 'Diagnostics', 27500, 25, 'CTK Biotech Inc, USA — OnSite HCV Ab Plus Combo Rapid Test Cassette'],
            ['CTK-002', 'R0042C / OnSite HBsAg Combo Rapid Test Cassette, 30 Test/kit', 'Diagnostics', 26500, 25, 'CTK Biotech Inc, USA — OnSite HBsAg Combo Rapid Test Cassette'],
            ['CTK-003', 'OnSite Syphilis Ab Combo Rapid Test Cassette, 30 Test/kit', 'Diagnostics', 28000, 25, 'CTK Biotech Inc, USA — OnSite Syphilis Ab Combo Rapid Test Cassette'],
            ['CTK-004', 'R0111C / OnSite Malaria P.f/P.v Ab Combo Rapid Test Cassette, 30 Test/kit', 'Diagnostics', 33500, 25, 'CTK Biotech Inc, USA — OnSite Malaria P.f/P.v Ab Combo Rapid Test Cassette'],
            ['CTK-005', 'R1001C / OnSite hCG Combo Rapid Test Cassette, 30 Test/kit', 'Diagnostics', 25100, 25, 'CTK Biotech Inc, USA — OnSite hCG Combo Rapid Test Cassette'],
            ['CTK-006', 'R0191C / OnSite H.pylori Ab Combo Rapid Test Cassette, 30 Test/kit', 'Diagnostics', 35600, 25, 'CTK Biotech Inc, USA — OnSite H.pylori Ab Combo Rapid Test Cassette'],
            ['CTK-007', 'E0511 / HCV Ab ELISA, 96 Test/kit', 'Diagnostics', 58900, 15, 'CTK Biotech Inc, USA — HCV Ab ELISA Kit'],
            ['CTK-008', 'E0610 / Syphilis Ab ELISA, 96 Test/kit', 'Diagnostics', 50500, 15, 'CTK Biotech Inc, USA — Syphilis Ab ELISA Kit'],
            ['CTK-009', 'E0710 / HBsAg ELISA, 96 Test/kit', 'Diagnostics', 47800, 15, 'CTK Biotech Inc, USA — HBsAg ELISA Kit'],
            ['CTK-010', 'E0420 / HIV 1+2 Ag-Ab ELISA, 96 Test/kit', 'Diagnostics', 105500, 15, 'CTK Biotech Inc, USA — HIV 1+2 Ag-Ab ELISA Kit'],
        ];
